USE [SSRPM]
GO
/****** Object:  StoredProcedure [dbo].[EnrollUser]    Script Date: 06/08/2015 14:00:06 ******/
SET ANSI_NULLS ON
GO
...
-----------DEBUGGING VARIABLES----------------
	...
	--DECLARE @AD_CononicalName varchar(max)
	--DECLARE @AD_sAMAccountName varchar(255)
	--DECLARE @AD_ObjectSID varchar(255)
	--DECLARE @XML_Answers XML
	
	--SET @ProfileID = 10
	--SET @AD_CononicalName = 'sbdom.sbcusd/Administrative/BOED/COMM/Sb2000Guy'
...
-----------END DEBUGGING VARIABLES--------------
	...
	insert into [SSRPM].[dbo].[Enrolled Users] ([Account Name] 
		,[Enrollment Time] 
		,[Block Time] 
		,[Block Count] 
		,[Reset Time] 
